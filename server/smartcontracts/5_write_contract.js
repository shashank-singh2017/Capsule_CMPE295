...
const account2 = '0xd26114cd6EE289AccF82350c8d8487fedB8A0D09' // Your account address 2

const privateKey1 = Buffer.from('14cd6EE289AccF82350c8d8', 'hex')
const privateKey2 = Buffer.from('c8d8487fedB8A0', 'hex')
...
web3.eth.getTransactionCount(account1, (err, txCount) => {
  ...
  web3.eth.sendSignedTransaction(raw, (err, txHash) => {
    ...
    // Used this txHash to find the contract on Etherscan!
  })
})
